                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="{{ route('login') }}" style="text-transform:uppercase;">
                                        @csrf
                                        ...
                                        <button class="btn btn-primary btn-user btn-block" type="submit" style="background-color:coral;border-color:coral;">
                                            Login
                                        </button>
                                        <hr>
                                    </form>
